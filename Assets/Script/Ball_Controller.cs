...
public class Ball_Controller : MonoBehaviour
{
    ...
    [SerializeField]
    public Local_Data Local_Data;
    [SerializeField]
    public Transform Camera_Transform, Ball_Clone_Transform;

    public Transform Ball_Original_Transform;
    [SerializeField]
    private float Push_Force;

    public float Applied_Push_Force = 0;
